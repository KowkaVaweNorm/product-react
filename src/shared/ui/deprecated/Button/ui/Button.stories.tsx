...
const meta: Meta<typeof Button> = {
  title: 'shared/depreacated/Button',
  component: Button,
  parameters: {
    screenshot: {
      viewport: 'iPhone 5',
...
export const Square: Story = {
  render: () => (
    <Button theme={ButtonTheme.BACKGROUND_INVERTED} square={true}>
      {'>'}
    </Button>
  ),
};
export const SquareSizeL: Story = {
  render: () => (
    <Button theme={ButtonTheme.BACKGROUND_INVERTED} square={true} size={ButtonSize.L}>
      {'>'}
    </Button>
  ),
};
export const SquareSizeXL: Story = {
  render: () => (
    <Button theme={ButtonTheme.BACKGROUND_INVERTED} square={true} size={ButtonSize.XL}>
      {'>'}
    </Button>
  ),
};
export const Disabled: Story = {
  render: () => (
    <Button theme={ButtonTheme.OUTLINE} disabled={true}>
      {'>'}
    </Button>
  ),
};
